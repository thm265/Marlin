...
#define STRING_CONFIG_H_AUTHOR "(Thomas Reichenbach, default config)" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 SHORT_BUILD_VERSION // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "RUEDIGER" //WEBSITE_URL         // will be shown during bootup in line 2
...
//#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 100), (Y_MIN_POS + 90), 100 }
